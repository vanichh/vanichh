...
Я хорошо верстую, знаю нативный JavaScript на хорошем уровне, нет проблем с написанием кода на TypeScript, большой опыт на React и библиотеками связанными с ним, послоедние год пишу на NextJs
